...
- (GSLoginManager *)initWithApplication:(UIApplication *)application launchOptions:(NSDictionary *)launchOptions
{
    ...
    if (self) {
        ...
        if ([GSLineProvider isAppConfiguredForProvider])
            providers[@"line"] = [GSLineProvider instance];
        
        if ([GSWeChatProvider isAppConfiguredForProvider])
            providers[@"wechat"] = [GSWeChatProvider instance];
...
- (void)clearSessionAfterLogout
{
    ...
    [[Gigya sharedInstance] deleteSessionFromKeychain];
